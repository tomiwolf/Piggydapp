              ...
              <div className="py-8 space-y-4 text-base leading-6 text-gray-700 sm:text-lg sm:leading-7">
                <ul className="space-y-2 list-disc">
                  ...
                  <li className="flex items-start">
                    ...
                    <p className="ml-2">
                      Hand-drawn, high-res scanned 3D ART. Irresistible.
                    </p>
                  </li>
                  <li className="flex items-start">
                    <span className="flex items-center h-6 sm:h-7">
                    ...
                    <p className="ml-2">
                      Over 10.000 traits, several rarity levels.
                    </p>
                  </li>
                  <li className="flex items-start">
                    <span className="flex items-center h-6 sm:h-7">
                    ...
                    <p className="ml-2">0.1 ETH per PIGGY.</p>
                  </li>
                </ul>
              </div>
              <div className="pt-6 text-base leading-6 font-extralight sm:text-lg sm:leading-7">
                <p>
                  {`The piggys seemed doomed to live as fancy props. Mere
